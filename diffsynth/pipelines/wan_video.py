...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        # Step callback for intermediate visualization
        step_callback=None,
        ...
        for progress_id, timestep in enumerate(progress_bar_cmd(self.scheduler.timesteps)):
            ...
            inputs_shared["latents"] = self.scheduler.step(noise_pred, self.scheduler.timesteps[progress_id], latents_before_step)
